...
```
结构图如下：
<img src="http://pdpv2lxdq.bkt.clouddn.com/link.png" alt="URDF机器人建模"><i><p align="right" style="color: gray; font-size:3px;">Source: <a  target="_blank" rel="external">ROS理论与实践_3:URDF机器人建模</a></p></i>
